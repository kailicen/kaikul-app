...
function Hero({}: Props) {
  return (
    ...
    absolute inset-0 bg-no-repeat bg-cover bg-center bg-fixed md:bg-[url('/img/mbg.jpg')] bg-violet-200"
    >
      <a
      ...
      >
        <h1 className="text-2xl md:text-3xl lg:text-4xl 2xl:text-5xl font-bold max-w-[800px] text-violet-800">
